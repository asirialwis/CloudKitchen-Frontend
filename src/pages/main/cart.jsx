...
const CartPage = () => {
  ...
  return (
    <div className="bg-gray-100">
      {/* Header Section */}
      <div className="relative h-52 sm:h-44 bg-gradient-to-r from-[#fe5725] to-[#ff7b3f] text-white flex flex-col justify-center items-center">
        <button
          onClick={() => navigate(-1)}
      ...
      <div className="max-w-4xl mx-auto p-4 sm:p-6 space-y-6">
        {cartItems.length === 0 ? (
          <div className="text-center text-gray-500 m-15 text-lg font-semibold">
            Your cart is empty 🛒
          </div>
        ) : (
          <>
            ...
            <div className="bg-white shadow rounded-lg p-6 flex flex-col sm:flex-row justify-between items-center gap-4">
              ...
              <button
                ...
                className="w-full sm:w-auto px-6 py-3 bg-[#fe5725] text-white font-semibold rounded-full hover:bg-[#e04a20] transition"
              >
                Pay Now
              </button>
            </div>
