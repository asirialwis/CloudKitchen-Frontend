...
const DriverNavigation = ({pickupLocation, dropoffLocation}) => {
  const [directions, setDirections] = useState(null);
  const [notification, setNotification] = useState(null);

  useEffect(() => {
    axios.get(`http://localhost:3000/api/notification-service/api/notifications/unread/680c7ee382e8bf5e85dfda4a`).then(res => setNotification(res.data) ).catch(err => alert(err.response.data.message))
  }, [])
